...
#ifndef _Lan_util_VoidList_
#define _Lan_util_VoidList_
...
public:
	...
	void remove(int i, bool dontDelete=false){
		iterator itr=base::begin();
		itr+=i;
		_kt key = *itr;
		base::erase( itr );
...
template<typename _kt, typename _valueDeletor=Lan::util::Deletor::Dummy> 
class CLVector:public __CLList<_kt, std::vector<_kt> , _valueDeletor>
{
public:
	CLVector ( const bool deleteValue=true ):
	  __CLList<_kt, std::vector<_kt> , _valueDeletor>(deleteValue)
	{
	}
};
...
template<typename _kt,
	typename _Comparator=Lan::util::Compare::TChar,
	typename _valueDeletor=Lan::util::Deletor::Dummy> 
class CLHashList:public __CLList<_kt, stdext::hash_set<_kt,_Comparator> , _valueDeletor>
{
public:
	CLHashList ( const bool deleteValue=true ):
	  __CLList<_kt, stdext::hash_set<_kt,_Comparator> , _valueDeletor>(deleteValue)
	{
	}
};
#endif
...
class CLLinkedList:public __CLList<_kt, std::list<_kt> , _valueDeletor>
{
public:
	CLLinkedList ( const bool deleteValue=true ):
	  __CLList<_kt, std::list<_kt> , _valueDeletor>(deleteValue)
	{
	}
};
template<typename _kt,
	typename _Comparator=Lan::util::Compare::TChar,
	typename _valueDeletor=Lan::util::Deletor::Dummy> 
class CLSetList:public __CLList<_kt, std::set<_kt,_Comparator> , _valueDeletor>
{
public:
	CLSetList ( const bool deleteValue=true ):
	  __CLList<_kt, std::set<_kt,_Comparator> , _valueDeletor>(deleteValue)
	{
	}
};
